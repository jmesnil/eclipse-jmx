 ...
 *******************************************************************************/
package net.jmesnil.jmx.resources.internal.providers;
...
import net.jmesnil.jmx.resources.IMemento;
import net.jmesnil.jmx.resources.JMXActivator;
import net.jmesnil.jmx.resources.JMXException;
import net.jmesnil.jmx.resources.tree.NodeUtils;
import net.jmesnil.jmx.resources.tree.Root;
import net.jmesnil.jmx.resources.util.XMLMemento;
...
public class DefaultConnectionProvider implements IConnectionProvider {
	public static final String PROVIDER_ID = "net.jmesnil.jmx.resources.internal.providers.DefaultConnectionProvider"; //$NON-NLS-1$
